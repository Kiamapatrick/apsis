...
foreach ($file in $files) {
    ...
    if (Test-Path $path) {
        ...
        # Find the footer-grid section and insert Our Services column after Quick Links column
        # Pattern: Quick Links column ends with </ul></div> then comes footer-map-col
